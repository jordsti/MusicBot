...
from .entry import URLPlaylistEntry, BasePlaylistEntry, LocalPlaylistEntry
...
class Playlist(EventEmitter):
	...
	async def add_local_entry(self, music_entry):
		self._add_entry(LocalPlaylistEntry(music_entry))
